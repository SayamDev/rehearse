...
const profile: Profile = {
  ...
  settings: { deliveryMetrics: true, defaultAnswerMode: "type", readAloud: true, voiceEngine: "standard", voiceSpeed: 1, helpers: true, softMode: false, keepRecordings: false, largeText: false, plainWords: false, language: "en", theme: "system" },
  seen: [],
  askList: [],
